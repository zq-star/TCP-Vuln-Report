...
2. In test machine - virtual machine 1:
   ...
   * Run `sudo python poc.py`. The [poc.py](https://github.com/zq-star/TCP-Vuln-Report/blob/master/Omnios-r151046-5.11/tcp-syn/poc.py) sends packets of specified types in order: LISTEN, SYN(V, 0), SYN(INV, 0).
3. Capture packets to observe responses of ubuntu system - virtual machine 2 during running [poc.py](https://github.com/zq-star/TCP-Vuln-Report/blob/master/Omnios-r151046-5.11/tcp-syn/poc.py):
