...
def main():
    ...
    '''
        ...
        send(push_ack2)
    '''
    syn_ack1 = ScapyIP(dst=SERVER_ADDR) / ScapyTCP(sport=LEARNER_PORT, dport=new_port, flags="SA", seq=rand_seq, ack=rand_ack)
    
    syn_fin1 = ScapyIP(dst=SERVER_ADDR) / ScapyTCP(sport=LEARNER_PORT, dport=new_port, flags="SF", seq=rand_seq, ack=rand_ack)
